...
export const dustmereVillage = new Location(
  LocationsEnum.DustmereVillage,
  {
    en: "Dustmere Village",
    th: "",
  },
  SubRegionEnum.EastfieldFrontier,
  [],
  {
    [TimeOfDay.morning]: [
      ActionInput.Rest,
  ...
  undefined,
  {
    [InnLevel.Poor]: { costPerRoom: 70, roomSize: 2 },
    [InnLevel.Comfortable]: { costPerRoom: 220, roomSize: 2 },
