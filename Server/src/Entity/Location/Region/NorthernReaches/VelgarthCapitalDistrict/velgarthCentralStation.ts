...
export const velgarthCentralStation = new Location(
  LocationsEnum.VelgarthCentralStation,
  {
    en: "Velgarth Central Station",
    th: "",
  },
...
velgarthCentralStation.setTrainStation(RailStationEnum.VelgarthCentralStation);
