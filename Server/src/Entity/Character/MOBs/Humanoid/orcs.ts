...
const baseOrcAttrs = RACE_ATTRIBUTES[RaceEnum.Orc].attributes;

export function orcWarrior(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseOrcAttrs.charisma + 1, difficulty),
      luck: scaleByDifficulty(baseOrcAttrs.luck, difficulty),
      intelligence: scaleByDifficulty(baseOrcAttrs.intelligence - 1, difficulty),
      leadership: scaleByDifficulty(baseOrcAttrs.leadership + 2, difficulty),
      vitality: scaleByDifficulty(baseOrcAttrs.vitality + 3, difficulty),
      willpower: scaleByDifficulty(baseOrcAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseOrcAttrs.planar - 2, difficulty),
      control: scaleByDifficulty(baseOrcAttrs.control, difficulty),
      dexterity: scaleByDifficulty(baseOrcAttrs.dexterity + 1, difficulty),
      agility: scaleByDifficulty(baseOrcAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseOrcAttrs.strength + 3, difficulty),
      endurance: scaleByDifficulty(baseOrcAttrs.endurance + 2, difficulty),
    }),
...
export function orcRanger(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    artisans: new CharacterArtisans({}),
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseOrcAttrs.charisma, difficulty),
      luck: scaleByDifficulty(baseOrcAttrs.luck + 2, difficulty),
      intelligence: scaleByDifficulty(baseOrcAttrs.intelligence + 1, difficulty),
      leadership: scaleByDifficulty(baseOrcAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseOrcAttrs.vitality + 1, difficulty),
      willpower: scaleByDifficulty(baseOrcAttrs.willpower, difficulty),
      planar: scaleByDifficulty(baseOrcAttrs.planar, difficulty),
      control: scaleByDifficulty(baseOrcAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseOrcAttrs.dexterity + 3, difficulty),
      agility: scaleByDifficulty(baseOrcAttrs.agility + 2, difficulty),
      strength: scaleByDifficulty(baseOrcAttrs.strength + 1, difficulty),
      endurance: scaleByDifficulty(baseOrcAttrs.endurance + 1, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
...
export function orcMage(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseOrcAttrs.charisma + 1, difficulty),
      luck: scaleByDifficulty(baseOrcAttrs.luck, difficulty),
      intelligence: scaleByDifficulty(baseOrcAttrs.intelligence + 3, difficulty),
      leadership: scaleByDifficulty(baseOrcAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseOrcAttrs.vitality - 1, difficulty),
      willpower: scaleByDifficulty(baseOrcAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseOrcAttrs.planar + 3, difficulty),
      control: scaleByDifficulty(baseOrcAttrs.control + 2, difficulty),
      dexterity: scaleByDifficulty(baseOrcAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseOrcAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseOrcAttrs.strength - 2, difficulty),
      endurance: scaleByDifficulty(baseOrcAttrs.endurance - 1, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
...
export function orcCleric(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    artisans: new CharacterArtisans({}),
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseOrcAttrs.charisma + 2, difficulty),
      luck: scaleByDifficulty(baseOrcAttrs.luck, difficulty),
      intelligence: scaleByDifficulty(baseOrcAttrs.intelligence + 2, difficulty),
      leadership: scaleByDifficulty(baseOrcAttrs.leadership + 1, difficulty),
      vitality: scaleByDifficulty(baseOrcAttrs.vitality + 2, difficulty),
      willpower: scaleByDifficulty(baseOrcAttrs.willpower + 3, difficulty),
      planar: scaleByDifficulty(baseOrcAttrs.planar + 2, difficulty),
      control: scaleByDifficulty(baseOrcAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseOrcAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseOrcAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseOrcAttrs.strength, difficulty),
      endurance: scaleByDifficulty(baseOrcAttrs.endurance + 1, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
...
export function orcPaladin(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      ...
      leadership: scaleByDifficulty(baseOrcAttrs.leadership + 2, difficulty),
      vitality: scaleByDifficulty(baseOrcAttrs.vitality + 3, difficulty),
      willpower: scaleByDifficulty(baseOrcAttrs.willpower + 2, difficulty),
      planar: scaleByDifficulty(baseOrcAttrs.planar + 1, difficulty),
      control: scaleByDifficulty(baseOrcAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseOrcAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseOrcAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseOrcAttrs.strength + 2, difficulty),
      endurance: scaleByDifficulty(baseOrcAttrs.endurance + 3, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
...
export function orcWarlock(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    artisans: new CharacterArtisans({}),
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseOrcAttrs.charisma + 3, difficulty),
      luck: scaleByDifficulty(baseOrcAttrs.luck - 1, difficulty),
      intelligence: scaleByDifficulty(baseOrcAttrs.intelligence + 2, difficulty),
      leadership: scaleByDifficulty(baseOrcAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseOrcAttrs.vitality, difficulty),
      willpower: scaleByDifficulty(baseOrcAttrs.willpower + 2, difficulty),
      planar: scaleByDifficulty(baseOrcAttrs.planar + 3, difficulty),
      control: scaleByDifficulty(baseOrcAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseOrcAttrs.dexterity, difficulty),
...
export function orcBarbarian(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      ...
      intelligence: scaleByDifficulty(baseOrcAttrs.intelligence - 2, difficulty),
      leadership: scaleByDifficulty(baseOrcAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseOrcAttrs.vitality + 4, difficulty),
      willpower: scaleByDifficulty(baseOrcAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseOrcAttrs.planar - 3, difficulty),
      control: scaleByDifficulty(baseOrcAttrs.control - 1, difficulty),
      dexterity: scaleByDifficulty(baseOrcAttrs.dexterity + 1, difficulty),
      agility: scaleByDifficulty(baseOrcAttrs.agility + 1, difficulty),
      strength: scaleByDifficulty(baseOrcAttrs.strength + 4, difficulty),
      endurance: scaleByDifficulty(baseOrcAttrs.endurance + 3, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
...
export function orcSorcerer(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      ...
      vitality: scaleByDifficulty(baseOrcAttrs.vitality - 1, difficulty),
      willpower: scaleByDifficulty(baseOrcAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseOrcAttrs.planar + 4, difficulty),
      control: scaleByDifficulty(baseOrcAttrs.control + 3, difficulty),
      dexterity: scaleByDifficulty(baseOrcAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseOrcAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseOrcAttrs.strength - 2, difficulty),
      endurance: scaleByDifficulty(baseOrcAttrs.endurance - 1, difficulty),
...
export function orcRogue(difficulty: 1 | 2 | 3 | 4 | 5) {
  const hp = scaleByDifficulty(16, difficulty);
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseOrcAttrs.charisma + 1, difficulty),
      luck: scaleByDifficulty(baseOrcAttrs.luck + 3, difficulty),
      intelligence: scaleByDifficulty(baseOrcAttrs.intelligence + 1, difficulty),
      leadership: scaleByDifficulty(baseOrcAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseOrcAttrs.vitality, difficulty),
      willpower: scaleByDifficulty(baseOrcAttrs.willpower, difficulty),
      planar: scaleByDifficulty(baseOrcAttrs.planar, difficulty),
      control: scaleByDifficulty(baseOrcAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseOrcAttrs.dexterity + 4, difficulty),
      agility: scaleByDifficulty(baseOrcAttrs.agility + 3, difficulty),
      strength: scaleByDifficulty(baseOrcAttrs.strength, difficulty),
      endurance: scaleByDifficulty(baseOrcAttrs.endurance, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
...
export function orcDruid(difficulty: 1 | 2 | 3 | 4 | 5) {
