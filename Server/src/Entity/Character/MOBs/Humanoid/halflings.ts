...
const baseHalflingAttrs = RACE_ATTRIBUTES[RaceEnum.Halfling].attributes;

export function halflingWarrior(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseHalflingAttrs.charisma + 1, difficulty),
      luck: scaleByDifficulty(baseHalflingAttrs.luck, difficulty),
      intelligence: scaleByDifficulty(baseHalflingAttrs.intelligence - 1, difficulty),
      leadership: scaleByDifficulty(baseHalflingAttrs.leadership + 2, difficulty),
      vitality: scaleByDifficulty(baseHalflingAttrs.vitality + 3, difficulty),
      willpower: scaleByDifficulty(baseHalflingAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseHalflingAttrs.planar - 2, difficulty),
      control: scaleByDifficulty(baseHalflingAttrs.control, difficulty),
      dexterity: scaleByDifficulty(baseHalflingAttrs.dexterity + 1, difficulty),
      agility: scaleByDifficulty(baseHalflingAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseHalflingAttrs.strength + 3, difficulty),
      endurance: scaleByDifficulty(baseHalflingAttrs.endurance + 2, difficulty),
    }),
  ...
  character.race = RaceEnum.Halfling;
...
export function halflingRanger(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    artisans: new CharacterArtisans({}),
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseHalflingAttrs.charisma, difficulty),
      luck: scaleByDifficulty(baseHalflingAttrs.luck + 2, difficulty),
      intelligence: scaleByDifficulty(baseHalflingAttrs.intelligence + 1, difficulty),
      leadership: scaleByDifficulty(baseHalflingAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseHalflingAttrs.vitality + 1, difficulty),
      willpower: scaleByDifficulty(baseHalflingAttrs.willpower, difficulty),
      planar: scaleByDifficulty(baseHalflingAttrs.planar, difficulty),
      control: scaleByDifficulty(baseHalflingAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseHalflingAttrs.dexterity + 3, difficulty),
      agility: scaleByDifficulty(baseHalflingAttrs.agility + 2, difficulty),
      strength: scaleByDifficulty(baseHalflingAttrs.strength + 1, difficulty),
      endurance: scaleByDifficulty(baseHalflingAttrs.endurance + 1, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
...
export function halflingMage(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseHalflingAttrs.charisma + 1, difficulty),
      luck: scaleByDifficulty(baseHalflingAttrs.luck, difficulty),
      intelligence: scaleByDifficulty(baseHalflingAttrs.intelligence + 3, difficulty),
      leadership: scaleByDifficulty(baseHalflingAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseHalflingAttrs.vitality - 1, difficulty),
      willpower: scaleByDifficulty(baseHalflingAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseHalflingAttrs.planar + 3, difficulty),
      control: scaleByDifficulty(baseHalflingAttrs.control + 2, difficulty),
      dexterity: scaleByDifficulty(baseHalflingAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseHalflingAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseHalflingAttrs.strength - 2, difficulty),
      endurance: scaleByDifficulty(baseHalflingAttrs.endurance - 1, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
...
export function halflingCleric(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    artisans: new CharacterArtisans({}),
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseHalflingAttrs.charisma + 2, difficulty),
      luck: scaleByDifficulty(baseHalflingAttrs.luck, difficulty),
      intelligence: scaleByDifficulty(baseHalflingAttrs.intelligence + 2, difficulty),
      leadership: scaleByDifficulty(baseHalflingAttrs.leadership + 1, difficulty),
      vitality: scaleByDifficulty(baseHalflingAttrs.vitality + 2, difficulty),
      willpower: scaleByDifficulty(baseHalflingAttrs.willpower + 3, difficulty),
      planar: scaleByDifficulty(baseHalflingAttrs.planar + 2, difficulty),
      control: scaleByDifficulty(baseHalflingAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseHalflingAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseHalflingAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseHalflingAttrs.strength, difficulty),
      endurance: scaleByDifficulty(baseHalflingAttrs.endurance + 1, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
...
export function halflingPaladin(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      ...
      leadership: scaleByDifficulty(baseHalflingAttrs.leadership + 2, difficulty),
      vitality: scaleByDifficulty(baseHalflingAttrs.vitality + 3, difficulty),
      willpower: scaleByDifficulty(baseHalflingAttrs.willpower + 2, difficulty),
      planar: scaleByDifficulty(baseHalflingAttrs.planar + 1, difficulty),
      control: scaleByDifficulty(baseHalflingAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseHalflingAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseHalflingAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseHalflingAttrs.strength + 2, difficulty),
      endurance: scaleByDifficulty(baseHalflingAttrs.endurance + 3, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
...
export function halflingWarlock(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    artisans: new CharacterArtisans({}),
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseHalflingAttrs.charisma + 3, difficulty),
      luck: scaleByDifficulty(baseHalflingAttrs.luck - 1, difficulty),
      intelligence: scaleByDifficulty(baseHalflingAttrs.intelligence + 2, difficulty),
      leadership: scaleByDifficulty(baseHalflingAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseHalflingAttrs.vitality, difficulty),
      willpower: scaleByDifficulty(baseHalflingAttrs.willpower + 2, difficulty),
      planar: scaleByDifficulty(baseHalflingAttrs.planar + 3, difficulty),
      control: scaleByDifficulty(baseHalflingAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseHalflingAttrs.dexterity, difficulty),
...
export function halflingBarbarian(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      ...
      intelligence: scaleByDifficulty(baseHalflingAttrs.intelligence - 2, difficulty),
      leadership: scaleByDifficulty(baseHalflingAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseHalflingAttrs.vitality + 4, difficulty),
      willpower: scaleByDifficulty(baseHalflingAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseHalflingAttrs.planar - 3, difficulty),
      control: scaleByDifficulty(baseHalflingAttrs.control - 1, difficulty),
      dexterity: scaleByDifficulty(baseHalflingAttrs.dexterity + 1, difficulty),
      agility: scaleByDifficulty(baseHalflingAttrs.agility + 1, difficulty),
      strength: scaleByDifficulty(baseHalflingAttrs.strength + 4, difficulty),
      endurance: scaleByDifficulty(baseHalflingAttrs.endurance + 3, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
...
export function halflingSorcerer(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      ...
      vitality: scaleByDifficulty(baseHalflingAttrs.vitality - 1, difficulty),
      willpower: scaleByDifficulty(baseHalflingAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseHalflingAttrs.planar + 4, difficulty),
      control: scaleByDifficulty(baseHalflingAttrs.control + 3, difficulty),
      dexterity: scaleByDifficulty(baseHalflingAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseHalflingAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseHalflingAttrs.strength - 2, difficulty),
      endurance: scaleByDifficulty(baseHalflingAttrs.endurance - 1, difficulty),
...
export function halflingRogue(difficulty: 1 | 2 | 3 | 4 | 5) {
  const hp = scaleByDifficulty(16, difficulty);
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseHalflingAttrs.charisma + 1, difficulty),
      luck: scaleByDifficulty(baseHalflingAttrs.luck + 3, difficulty),
      intelligence: scaleByDifficulty(baseHalflingAttrs.intelligence + 1, difficulty),
      leadership: scaleByDifficulty(baseHalflingAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseHalflingAttrs.vitality, difficulty),
      willpower: scaleByDifficulty(baseHalflingAttrs.willpower, difficulty),
      planar: scaleByDifficulty(baseHalflingAttrs.planar, difficulty),
      control: scaleByDifficulty(baseHalflingAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseHalflingAttrs.dexterity + 4, difficulty),
      agility: scaleByDifficulty(baseHalflingAttrs.agility + 3, difficulty),
      strength: scaleByDifficulty(baseHalflingAttrs.strength, difficulty),
      endurance: scaleByDifficulty(baseHalflingAttrs.endurance, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
...
export function halflingDruid(difficulty: 1 | 2 | 3 | 4 | 5) {
