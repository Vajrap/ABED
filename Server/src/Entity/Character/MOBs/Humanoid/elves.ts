...
export function elvenWarrior(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseElvenAttrs.charisma + 1, difficulty),
      luck: scaleByDifficulty(baseElvenAttrs.luck, difficulty),
      intelligence: scaleByDifficulty(baseElvenAttrs.intelligence - 1, difficulty),
      leadership: scaleByDifficulty(baseElvenAttrs.leadership + 2, difficulty),
      vitality: scaleByDifficulty(baseElvenAttrs.vitality + 3, difficulty),
      willpower: scaleByDifficulty(baseElvenAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseElvenAttrs.planar - 2, difficulty),
      control: scaleByDifficulty(baseElvenAttrs.control, difficulty),
      dexterity: scaleByDifficulty(baseElvenAttrs.dexterity + 1, difficulty),
      agility: scaleByDifficulty(baseElvenAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseElvenAttrs.strength + 3, difficulty),
      endurance: scaleByDifficulty(baseElvenAttrs.endurance + 2, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenWarrior}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Warrior",
      th: "นักรบเอลฟ์",
...
export function elvenRanger(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    artisans: new CharacterArtisans({}),
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseElvenAttrs.charisma, difficulty),
      luck: scaleByDifficulty(baseElvenAttrs.luck + 2, difficulty),
      intelligence: scaleByDifficulty(baseElvenAttrs.intelligence + 1, difficulty),
      leadership: scaleByDifficulty(baseElvenAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseElvenAttrs.vitality + 1, difficulty),
      willpower: scaleByDifficulty(baseElvenAttrs.willpower, difficulty),
      planar: scaleByDifficulty(baseElvenAttrs.planar, difficulty),
      control: scaleByDifficulty(baseElvenAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseElvenAttrs.dexterity + 3, difficulty),
      agility: scaleByDifficulty(baseElvenAttrs.agility + 2, difficulty),
      strength: scaleByDifficulty(baseElvenAttrs.strength + 1, difficulty),
      endurance: scaleByDifficulty(baseElvenAttrs.endurance + 1, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenRanger}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Ranger",
      th: "นักล่าเอลฟ์",
...
export function elvenMage(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseElvenAttrs.charisma + 1, difficulty),
      luck: scaleByDifficulty(baseElvenAttrs.luck, difficulty),
      intelligence: scaleByDifficulty(baseElvenAttrs.intelligence + 3, difficulty),
      leadership: scaleByDifficulty(baseElvenAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseElvenAttrs.vitality - 1, difficulty),
      willpower: scaleByDifficulty(baseElvenAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseElvenAttrs.planar + 3, difficulty),
      control: scaleByDifficulty(baseElvenAttrs.control + 2, difficulty),
      dexterity: scaleByDifficulty(baseElvenAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseElvenAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseElvenAttrs.strength - 2, difficulty),
      endurance: scaleByDifficulty(baseElvenAttrs.endurance - 1, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenMage}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Mage",
      th: "นักเวทย์เอลฟ์",
...
export function elvenCleric(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    artisans: new CharacterArtisans({}),
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseElvenAttrs.charisma + 2, difficulty),
      luck: scaleByDifficulty(baseElvenAttrs.luck, difficulty),
      intelligence: scaleByDifficulty(baseElvenAttrs.intelligence + 2, difficulty),
      leadership: scaleByDifficulty(baseElvenAttrs.leadership + 1, difficulty),
      vitality: scaleByDifficulty(baseElvenAttrs.vitality + 2, difficulty),
      willpower: scaleByDifficulty(baseElvenAttrs.willpower + 3, difficulty),
      planar: scaleByDifficulty(baseElvenAttrs.planar + 2, difficulty),
      control: scaleByDifficulty(baseElvenAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseElvenAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseElvenAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseElvenAttrs.strength, difficulty),
      endurance: scaleByDifficulty(baseElvenAttrs.endurance + 1, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenCleric}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Cleric",
      th: "นักบวชเอลฟ์",
...
export function elvenPaladin(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      ...
      leadership: scaleByDifficulty(baseElvenAttrs.leadership + 2, difficulty),
      vitality: scaleByDifficulty(baseElvenAttrs.vitality + 3, difficulty),
      willpower: scaleByDifficulty(baseElvenAttrs.willpower + 2, difficulty),
      planar: scaleByDifficulty(baseElvenAttrs.planar + 1, difficulty),
      control: scaleByDifficulty(baseElvenAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseElvenAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseElvenAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseElvenAttrs.strength + 2, difficulty),
      endurance: scaleByDifficulty(baseElvenAttrs.endurance + 3, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenPaladin}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Paladin",
      th: "พาลาดินเอลฟ์",
...
export function elvenWarlock(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    artisans: new CharacterArtisans({}),
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseElvenAttrs.charisma + 3, difficulty),
      luck: scaleByDifficulty(baseElvenAttrs.luck - 1, difficulty),
      intelligence: scaleByDifficulty(baseElvenAttrs.intelligence + 2, difficulty),
      leadership: scaleByDifficulty(baseElvenAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseElvenAttrs.vitality, difficulty),
      willpower: scaleByDifficulty(baseElvenAttrs.willpower + 2, difficulty),
      planar: scaleByDifficulty(baseElvenAttrs.planar + 3, difficulty),
      control: scaleByDifficulty(baseElvenAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseElvenAttrs.dexterity, difficulty),
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenWarlock}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Warlock",
      th: "นักเวทย์มนตร์ดำเอลฟ์",
    },
    needs: new CharacterNeeds(),
    proficiencies: makeProficiencies({
      bareHand: scaleByDifficulty(2, difficulty),
...
export function elvenBarbarian(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      ...
      intelligence: scaleByDifficulty(baseElvenAttrs.intelligence - 2, difficulty),
      leadership: scaleByDifficulty(baseElvenAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseElvenAttrs.vitality + 4, difficulty),
      willpower: scaleByDifficulty(baseElvenAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseElvenAttrs.planar - 3, difficulty),
      control: scaleByDifficulty(baseElvenAttrs.control - 1, difficulty),
      dexterity: scaleByDifficulty(baseElvenAttrs.dexterity + 1, difficulty),
      agility: scaleByDifficulty(baseElvenAttrs.agility + 1, difficulty),
      strength: scaleByDifficulty(baseElvenAttrs.strength + 4, difficulty),
      endurance: scaleByDifficulty(baseElvenAttrs.endurance + 3, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenBarbarian}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Barbarian",
      th: "นักรบป่าเถื่อนเอลฟ์",
    },
    needs: new CharacterNeeds(),
    proficiencies: makeProficiencies({
...
export function elvenSorcerer(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      ...
      vitality: scaleByDifficulty(baseElvenAttrs.vitality - 1, difficulty),
      willpower: scaleByDifficulty(baseElvenAttrs.willpower + 1, difficulty),
      planar: scaleByDifficulty(baseElvenAttrs.planar + 4, difficulty),
      control: scaleByDifficulty(baseElvenAttrs.control + 3, difficulty),
      dexterity: scaleByDifficulty(baseElvenAttrs.dexterity, difficulty),
      agility: scaleByDifficulty(baseElvenAttrs.agility, difficulty),
      strength: scaleByDifficulty(baseElvenAttrs.strength - 2, difficulty),
      endurance: scaleByDifficulty(baseElvenAttrs.endurance - 1, difficulty),
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenSorcerer}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Sorcerer",
      th: "นักเวทย์มนตร์เอลฟ์",
    },
    needs: new CharacterNeeds(),
    proficiencies: makeProficiencies({
      bareHand: scaleByDifficulty(2, difficulty),
...
export function elvenRogue(difficulty: 1 | 2 | 3 | 4 | 5) {
  const hp = scaleByDifficulty(16, difficulty);
  ...
  const character = new Character({
    ...
    attribute: makeAttribute({
      charisma: scaleByDifficulty(baseElvenAttrs.charisma + 1, difficulty),
      luck: scaleByDifficulty(baseElvenAttrs.luck + 3, difficulty),
      intelligence: scaleByDifficulty(baseElvenAttrs.intelligence + 1, difficulty),
      leadership: scaleByDifficulty(baseElvenAttrs.leadership, difficulty),
      vitality: scaleByDifficulty(baseElvenAttrs.vitality, difficulty),
      willpower: scaleByDifficulty(baseElvenAttrs.willpower, difficulty),
      planar: scaleByDifficulty(baseElvenAttrs.planar, difficulty),
      control: scaleByDifficulty(baseElvenAttrs.control + 1, difficulty),
      dexterity: scaleByDifficulty(baseElvenAttrs.dexterity + 4, difficulty),
      agility: scaleByDifficulty(baseElvenAttrs.agility + 3, difficulty),
      strength: scaleByDifficulty(baseElvenAttrs.strength, difficulty),
      endurance: scaleByDifficulty(baseElvenAttrs.endurance, difficulty),
    }),
    battleStats: new CharacterBattleStats(),
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenRogue}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Rogue",
      th: "โจรเอลฟ์",
...
export function elvenDruid(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBEnum.elvenDruid}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Druid",
      th: "ดรูอิดเอลฟ์",
