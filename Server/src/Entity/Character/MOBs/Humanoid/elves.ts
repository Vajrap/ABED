...
export function elvenWarrior(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    id: `${MOBs.elvenWarrior}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Warrior",
      th: "นักรบเอลฟ์",
...
export function elvenRanger(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBs.elvenRanger}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Ranger",
      th: "นักล่าเอลฟ์",
...
export function elvenMage(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBs.elvenMage}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Mage",
      th: "นักเวทย์เอลฟ์",
...
export function elvenCleric(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBs.elvenCleric}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Cleric",
      th: "นักบวชเอลฟ์",
...
export function elvenPaladin(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBs.elvenPaladin}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Paladin",
      th: "พาลาดินเอลฟ์",
...
export function elvenWarlock(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBs.elvenWarlock}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Warlock",
...
export function elvenBarbarian(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBs.elvenBarbarian}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Barbarian",
...
export function elvenSorcerer(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBs.elvenSorcerer}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Sorcerer",
...
export function elvenRogue(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBs.elvenRogue}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Rogue",
      th: "โจรเอลฟ์",
...
export function elvenDruid(difficulty: 1 | 2 | 3 | 4 | 5) {
  ...
  const character = new Character({
    ...
    elements: new CharacterElements(),
    fame: new CharacterFame(),
    id: `${MOBs.elvenDruid}_${Bun.randomUUIDv7()}`,
    level: difficulty,
    name: {
      en: "Human Druid",
      th: "ดรูอิดเอลฟ์",
