...
class CharacterService {
    async createCharacter(characterData) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$services$2f$RestHandler$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["restHandler"].post("/api/characterCreation/create", characterData, true);
            return response;
        } catch (error) {
...
function getAvailableRaces() {
    ...
    const races = [];
    Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$app$2f$character$2d$creation$2f$characterStatsData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RACE_STATS"]).forEach((key)=>{
...
function getAvailableClasses() {
    ...
    const classes = [];
    Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$app$2f$character$2d$creation$2f$characterStatsData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CLASS_STATS"]).forEach((key)=>{
...
function getAvailableBackgrounds() {
    ...
    const backgrounds = [];
    Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$app$2f$character$2d$creation$2f$characterStatsData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BACKGROUND_STATS"]).forEach((key)=>{
        const canonicalId = key.charAt(0).toUpperCase() + key.slice(1).toLowerCase();
...
function useCharacterCreationLogic() {
    ...
    const createCharacter = async ()=>{
        ...
        if (!state.formData.name.trim()) {
            setState((prev)=>({
                    ...prev,
                    error: (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLocalizedText"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["L10N"].characterCreation.nameRequired, (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentLanguage"])())
                }));
            return false;
        }
        setState((prev)=>({
        ...
        try {
            ...
            if (response.success) {
                ...
                if (response.messageKey === "character.nameTaken" || response.message?.toLowerCase().includes("name") || response.message?.toLowerCase().includes("taken")) {
                    setState((prev)=>({
                            ...prev,
                            nameCheckMessage: (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLocalizedText"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["L10N"].characterCreation.nameTaken, (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentLanguage"])()),
                            isLoading: false
                        }));
                } else {
                    setState((prev)=>({
                            ...prev,
                            error: (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLocalizedText"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["L10N"].characterCreation.creationFailed, (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentLanguage"])()),
                            isLoading: false
                        }));
                }
                return false;
...
function CharacterCreationView() {
    ...
    const { t, currentLanguage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLocalization"])();
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ActionButtons, {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(CreateCharacterButton, {
                                    variant: "contained",
                                    size: "large",
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f40$mui$2f$material$2f$Typography$2f$Typography$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                                                        ...
                                                                        dangerouslySetInnerHTML: {
                                                                            __html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$utils$2f$textRenderer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["renderText"])(skillL10N.description, renderOptions)
                                                                        }
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/workspace/MyProject/Client/webapp/app/character-creation/CharacterCreationView.tsx",
                                                                        lineNumber: 636,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ce7fd09e._.js.map