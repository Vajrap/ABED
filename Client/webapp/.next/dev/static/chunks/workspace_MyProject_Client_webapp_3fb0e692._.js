...
class CharacterService {
    async createCharacter(characterData) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$services$2f$RestHandler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["restHandler"].post("/api/characterCreation/create", characterData, true);
            return response;
        } catch (error) {
...
function getAvailableRaces() {
    ...
    const races = [];
    Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$app$2f$character$2d$creation$2f$characterStatsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RACE_STATS"]).forEach((key)=>{
...
function normalizeToEnumValue(key) {
...
function getAvailableClasses() {
    ...
    const classes = [];
    Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$app$2f$character$2d$creation$2f$characterStatsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLASS_STATS"]).forEach((key)=>{
...
function getAvailableBackgrounds() {
    ...
    const backgrounds = [];
    Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$app$2f$character$2d$creation$2f$characterStatsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BACKGROUND_STATS"]).forEach((key)=>{
        const canonicalId = key.charAt(0).toUpperCase() + key.slice(1).toLowerCase();
...
function useCharacterCreationLogic() {
    ...
    const createCharacter = async ()=>{
        ...
        if (!state.formData.name.trim()) {
            setState((prev)=>({
                    ...prev,
                    error: (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLocalizedText"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["L10N"].characterCreation.nameRequired, (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentLanguage"])())
                }));
            return false;
        }
        setState((prev)=>({
        ...
        try {
            ...
            if (response.success) {
                ...
                if (response.messageKey === "character.nameTaken" || response.message?.toLowerCase().includes("name") || response.message?.toLowerCase().includes("taken")) {
                    setState((prev)=>({
                            ...prev,
                            nameCheckMessage: (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLocalizedText"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["L10N"].characterCreation.nameTaken, (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentLanguage"])()),
                            isLoading: false
                        }));
                } else {
                    setState((prev)=>({
                            ...prev,
                            error: (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLocalizedText"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["L10N"].characterCreation.creationFailed, (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentLanguage"])()),
                            isLoading: false
                        }));
                }
                return false;
    ...
    const isFormValid = ()=>{
        return state.formData.name.trim().length >= 3 && state.formData.name.trim().length <= 20 && /^[a-zA-Z\u0E00-\u0E7F\s]+$/.test(state.formData.name);
    };
...
_s(useCharacterCreationLogic, "GyelUMbgR6i8dMwF1QJRqiH0dSo=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const skillsL10N = {
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DruidSkillId"].RejuvenatingMist]: {
        name: {
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DruidSkillId"].ThrowSpear]: {
        name: {
            en: "Throw Spear",
            th: "ขว้างหอก"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DruidSkillId"].VineWhip]: {
        name: {
            en: "Vine Whip",
            th: "เถาวัลย์"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DuelistSkillId"].BladeFlurry]: {
        name: {
            en: "Blade Flurry",
            th: "ชุดการโจมตีดาบ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DuelistSkillId"].DuelingStance]: {
        name: {
            en: "Dueling Stance",
            th: "ท่าดวล"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DuelistSkillId"].ParryRiposte]: {
        name: {
            en: "Parry & Riposte",
            th: "ปัดป้องและตอบโต้"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DuelistSkillId"].PreciseStrike]: {
        name: {
            en: "Precise Strike",
            th: "โจมตีแม่นยำ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EngineerSkillId"].BearTrap]: {
        name: {
            en: "Bear Trap",
            th: "กับดักหมี"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EngineerSkillId"].ExplosiveBolt]: {
        name: {
            en: "Explosive Bolt",
            th: "ลูกธนูระเบิด"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GuardianSkillId"].Bash]: {
        name: {
            en: "Bash",
            th: "ทุบสุดแรง"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GuardianSkillId"].HerosPose]: {
        name: {
            en: "Hero's Pose",
            th: "ท่าเชิงฮีโร่"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GuardianSkillId"].ShieldUp]: {
        name: {
            en: "Shield Up",
            th: "ยกโล่ขึ้น"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GuardianSkillId"].Taunt]: {
        name: {
            en: "Taunt",
            th: "ยั่วยุ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InquisitorSkillId"].ExposeWeakness]: {
        name: {
            en: "Expose Weakness",
            th: "เปิดเผยจุดอ่อน"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InquisitorSkillId"].JudgmentDay]: {
        name: {
            en: "Judgment Day",
            th: "วันพิพากษา"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InquisitorSkillId"].PurgeMagic]: {
        name: {
            en: "Purge Magic",
            th: "ล้างเวทมนตร์"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InquisitorSkillId"].RadiantSmite]: {
        name: {
            en: "Radiant Smite",
            th: "การลงโทษด้วยแสง"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KnightSkillId"].AdvancingPace]: {
        name: {
            en: "Advancing Pace",
            th: "ก้าวจังหวะรุก"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KnightSkillId"].PrecisionThrust]: {
        name: {
            en: "Precision Thrust",
            th: "แทงทะลุจุด"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MageSkillId"].ArcaneBolt]: {
        name: {
            en: "Arcane Bolt",
            th: "ลูกเวทมนตร์"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MageSkillId"].ArcaneShield]: {
        name: {
            en: "Arcane Shield",
            th: "โล่เวทมนตร์"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MageSkillId"].Backdraft]: {
        name: {
            en: "Backdraft",
            th: "ไฟย้อนกลับ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MageSkillId"].BurningHand]: {
        name: {
            en: "Burning Hand",
            th: "มือไฟแผดเผา"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MageSkillId"].FireBall]: {
        name: {
            en: "Fireball",
            th: "ลูกไฟระเบิด"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MageSkillId"].FireBolt]: {
        name: {
            en: "Fire Bolt",
            th: "ลูกไฟ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MobSkillId"].CommanderScream]: {
        name: {
            en: "Commander Scream!",
            th: "คำสั่งกรีดร้อง!"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MobSkillId"].PanicSlash]: {
        name: {
            en: "Panic Slash",
            th: "ฟันแบบตื่นตระหนก"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MobSkillId"].Shriek]: {
        name: {
            en: "Shriek",
            th: "กรีดร้อง"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MobSkillId"].ThrowPebble]: {
        name: {
            en: "Throw Pebble",
            th: "ขว้างก้อนหิน"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MobSkillId"].Whip]: {
        name: {
            en: "Whip!",
            th: "แส้!"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MobSkillId"].WorksYouMaggots]: {
        name: {
            en: "Work You Maggots!",
            th: "ทำงานไอ้หนอน!"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MonkSkillId"].FlurryOfBlows]: {
        name: {
            en: "Flurry of Blows",
            th: "ชุดการโจมตี"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MonkSkillId"].Meditation]: {
        name: {
            en: "Meditation",
            th: "สมาธิ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MonkSkillId"].PalmStrike]: {
        name: {
            en: "Palm Strike",
            th: "ตบฝ่ามือ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MysticSkillId"].InnerVeil]: {
        name: {
            en: "Inner Veil",
            th: "ผ้าคลุมภายใน"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MysticSkillId"].MistStep]: {
        name: {
            en: "Mist Step",
            th: "ก้าวหมอก"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MysticSkillId"].PlanarAbsorption]: {
        name: {
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MysticSkillId"].ReversalPalm]: {
        name: {
            en: "Reversal Palm",
            th: "ฝ่ามือพลิก"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NomadSkillId"].AdaptiveStrike]: {
        name: {
            en: "Adaptive Strike",
            th: "การโจมตีปรับตัว"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NomadSkillId"].TacticalShot]: {
        name: {
            en: "Tactical Shot",
            th: "ยิงเชิงกลยุทธ์"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NomadSkillId"].TacticalSlash]: {
        name: {
            en: "Tactical Slash",
            th: "ฟันเชิงกลยุทธ์"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PaladinSkillId"].AegisPulse]: {
        name: {
            en: "Aegis Pulse",
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PaladinSkillId"].AegisShield]: {
        name: {
            en: "Aegis Shield",
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PaladinSkillId"].DivineStrike]: {
        name: {
            en: "Divine Strike",
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RogueSkillId"].Backstab]: {
        name: {
            en: "Backstab",
            th: "แทงข้างหลัง"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RogueSkillId"].BleedingCut]: {
        name: {
            en: "Bleeding Cut",
            th: "ตัดเลือดไหล"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RogueSkillId"].Hiding]: {
        name: {
            en: "Hiding",
            th: "ซ่อนตัว"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RogueSkillId"].RetreatDash]: {
        name: {
            en: "Retreat Dash",
            th: "วิ่งหนี"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RogueSkillId"].ThrowingKnives]: {
        name: {
            en: "Throwing Knives",
            th: "ขว้างมีด"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScholarSkillId"].Analyze]: {
        name: {
            en: "Analyze",
            th: "วิเคราะห์"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScholarSkillId"].CognitiveOverload]: {
        name: {
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScholarSkillId"].DisruptPattern]: {
        name: {
            en: "Disrupt Pattern",
            th: "ทำลายรูปแบบ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SeerSkillId"].PlanarEcho]: {
        name: {
            en: "Planar Echo",
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SeerSkillId"].Precognition]: {
        name: {
            en: "Precognition",
            th: "คาดการณ์"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SeerSkillId"].ThreadSnip]: {
        name: {
            en: "Thread Snip",
            th: "ตัดลวดระนาบ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShamanSkillId"].ChaoticBlessing]: {
        name: {
            en: "Chaotic Blessing",
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShamanSkillId"].HexOfRot]: {
        name: {
            en: "Hex of Rot",
            th: "คำสาปเน่าเปื่อย"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShamanSkillId"].HolyRattle]: {
        name: {
            en: "Holy Rattle",
            th: "กระดิ่งพระพรหม"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShamanSkillId"].MendSpirit]: {
        name: {
            en: "Mend Spirit",
            th: "ช่อมจิตวิญญาณ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SpellbladeSkillId"].EdgeBurst]: {
        name: {
            en: "Edge Burst",
            th: "ระเบิดขอบ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SpellbladeSkillId"].PlanarEdge]: {
        name: {
            en: "Planar Edge",
            th: "ขอบแห่งระนาบ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SpellbladeSkillId"].SpellParry]: {
        name: {
            en: "Spell Parry",
            th: "ปัดเวท"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SpellbladeSkillId"].WindSlash]: {
        name: {
            en: "Wind Slash",
            th: "ฟันลม"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WarlockSkillId"].ChaosBolt]: {
        name: {
            en: "Chaos Bolt",
            th: "ลูกบอลวินาศ"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WarlockSkillId"].Corruption]: {
        name: {
            en: "Corruption",
            th: "การเสื่อมสลาย"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WarlockSkillId"].DarkPact]: {
        name: {
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WarlockSkillId"].LifeDrain]: {
        name: {
            en: "Life Drain",
            th: "ดูดชีวิต"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WarriorSkillId"].Cleave]: {
        name: {
            en: "Cleave",
            th: "ฟันกวาด"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WarriorSkillId"].PowerStrike]: {
        name: {
            en: "Power Strike",
            th: "โจมตีแรง"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WarriorSkillId"].WarCry]: {
        name: {
            en: "War Cry",
            th: "เสียงร้องศึก"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WitchSkillId"].Bewitch]: {
        name: {
            en: "Bewitch",
            th: "สะกดจิต"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WitchSkillId"].ChaosBinding]: {
        name: {
            en: "Chaos Binding",
            th: "ตุ๊กตาสาป"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WitchSkillId"].ChaosBrand]: {
        name: {
            en: "Chaos Brand",
            th: "ประจุวินาที"
        },
    ...
    [__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WitchSkillId"].PoisonDart]: {
        name: {
            en: "Poison Dart",
            th: "ลูกบอลคำสาป"
        },
...
"[project]/workspace/MyProject/Client/webapp/src/utils/textRenderer.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/workspace/MyProject/Client/webapp/src/L10N/skillEnums.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$utils$2f$textRenderer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/workspace/MyProject/Client/webapp/src/utils/textRenderer.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function getSkillL10N(skillId, classValue, language = "en") {
    try {
        ...
        for (const enumName of allEnumNames){
            const enumType = __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skillEnums$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__[enumName];
            if (enumType) {
                const enumValue = enumType[skillId];
                if (enumValue) {
                    const skillData = __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$L10N$2f$skills$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["skillsL10N"][enumValue];
...
function CharacterCreationView() {
    ...
    const { t, currentLanguage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$localization$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocalization"])();
    const { isLoading, error, nameCheckMessage, stats, formData, portraitIndex, updateField, updatePortraitIndex, createCharacter, isFormValid, getAvailablePortraits, availableRaces, availableClasses, availableBackgrounds } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$app$2f$character$2d$creation$2f$useCharacterCreationLogic$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCharacterCreationLogic"])();
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FormSection, {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f40$mui$2f$material$2f$Stack$2f$Stack$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Stack$3e$__["Stack"], {
                                    ...
                                    flexWrap: "wrap",
                                    useFlexGap: true,
                                    children: availableClasses.map((classItem)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f40$mui$2f$material$2f$Chip$2f$Chip$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Chip$3e$__["Chip"], {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FormSection, {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f40$mui$2f$material$2f$Stack$2f$Stack$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Stack$3e$__["Stack"], {
                                    ...
                                    flexWrap: "wrap",
                                    useFlexGap: true,
                                    children: availableBackgrounds.map((background)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f40$mui$2f$material$2f$Chip$2f$Chip$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Chip$3e$__["Chip"], {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActionButtons, {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CreateCharacterButton, {
                                    variant: "contained",
                                    size: "large",
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$node_modules$2f40$mui$2f$material$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                                                        ...
                                                                        dangerouslySetInnerHTML: {
                                                                            __html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$utils$2f$textRenderer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["renderText"])(skillL10N.description, renderOptions)
                                                                        }
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/workspace/MyProject/Client/webapp/app/character-creation/CharacterCreationView.tsx",
                                                                        lineNumber: 636,
...
_s(CharacterCreationView, "dBK9Idy5r5FiTGPAsn3vIWNT0eU=", false, function() {
    return [
...
__turbopack_context__.k.register(_c11, "CreateCharacterButton");
__turbopack_context__.k.register(_c12, "CharacterCreationView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=workspace_MyProject_Client_webapp_3fb0e692._.js.map