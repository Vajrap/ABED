...
function useCharacterCreationLogic() {
    ...
    const fetchStatsPreview = async (race, classValue, background)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$workspace$2f$MyProject$2f$Client$2f$webapp$2f$src$2f$services$2f$characterService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["characterService"].previewStats(race, classValue, background);
...
_s(CharacterCreationView, "Wg9aL3XHXjbb09WbbeZDjcZOxEA=", false, function() {
    return [
...
//# sourceMappingURL=workspace_MyProject_Client_webapp_d14323f6._.js.map