...
function getSkillL10N(skillId, classValue, language = "en") {
    try {
        ...
        const { skillsL10N } = __turbopack_context__.r("[project]/workspace/MyProject/Client/webapp/src/L10N/skills.ts [app-client] (ecmascript)");
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        const skillEnums = __turbopack_context__.r("[project]/workspace/MyProject/Client/webapp/src/L10N/skillEnums.ts [app-client] (ecmascript)");
        ...
        const enumType = skillEnums[enumTypeName];
        if (!enumType) {
        ...
        const skillData = skillsL10N[enumValue];
        if (!skillData) {
...
//# sourceMappingURL=workspace_MyProject_Client_webapp_6d1eaea0._.js.map